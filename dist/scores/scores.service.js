...
var ScoresService = /** @class */ (function () {
    function ScoresService(scoresRepository) {
        this.scoresRepository = scoresRepository;
    }
    ScoresService.prototype.create = function (score) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.scoresRepository.save(score)];
            });
        });
    };
    ScoresService.prototype.findTop10 = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.scoresRepository.find({
                        order: {
                            score: 'DESC',
                        },
                        take: 10,
